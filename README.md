...
- NP4-190-CD and NP6-905-CD artifact paths are pinned from the 2026-09-24 catalog extract. See [`Data/docs/ercot-adapter-pins.md`](Data/docs/ercot-adapter-pins.md). One hundred seventy-one verified price zips are retained under `Data/archives/ercot/2026-09-24/` (`source_batch_count` 171, including batch 9’s 27 zips). That is not five-year coverage. Live From/To for 2023-06-15 returned no rows on both price products. No zip in this drop has that CSV delivery date. Archive files now include real-time intervals whose CSV delivery date is 2022-02-15. This drop did not re-query that live endpoint. 2024-11-15 From/To pages have rows; only pages 1–3 were kept. The day-ahead zip posted 2024-11-14 covers DeliveryDate 11/15/2024. Earlier empty artifact days that this drop did not re-query include 2021-02-15, 2021-08-15, and 2023-08-15. NP4-180-ER and NP6-785-ER are absent from that catalog and still GATE. The OpenAPI file URL and credentials are still GATE. Internal pack use is owner-approved. Commercial App Store redistribution is not authorized.
