...
- NP4-190-CD and NP6-905-CD artifact paths are pinned from the 2026-09-24 catalog extract. See [`Data/docs/ercot-adapter-pins.md`](Data/docs/ercot-adapter-pins.md). Eighty-eight verified price zips are retained under `Data/archives/ercot/2026-09-24/` (`source_batch_count` 88, including batch 6’s 25 zips). That is not five-year coverage. Live From/To is empty for 2022-11-15. Archive files now include delivery dates that were empty on earlier live fetches, including 2021-04-15, 2022-07-15, 2023-01-15, and 2023-04-15. Earlier empty artifact days that this drop did not re-query include 2021-02-15, 2021-08-15, 2022-02-15, and 2023-08-15. NP4-180-ER and NP6-785-ER are absent from that catalog and still GATE. The OpenAPI file URL and credentials are still GATE. Internal pack use is owner-approved. Commercial App Store redistribution is not authorized.
