...
- NP4-190-CD and NP6-905-CD artifact paths are pinned from the 2026-09-24 catalog extract. See [`Data/docs/ercot-adapter-pins.md`](Data/docs/ercot-adapter-pins.md). One hundred ninety-nine verified price zips are retained under `Data/archives/ercot/2026-09-24/` (`source_batch_count` 199, including batch 10’s 28 zips). That is not five-year coverage. Live From/To for 2021-03-15 returned no rows on both price products. No day-ahead zip in this drop has that CSV delivery date. Two real-time intervals have CSV delivery date 2021-03-15 (hour 12, intervals 3 and 4). Those are archive samples, not a live From/To fill. 2025-04-15 From/To pages have rows; only pages 1–3 were kept. The day-ahead zip posted 2024-07-14 covers DeliveryDate 07/15/2024. Months 2024-12 and 2025-05, 2025-06, 2025-07, 2025-09, 2025-10, and 2025-11 were not recorded as a live From/To empty day in this drop. NP4-180-ER and NP6-785-ER are absent from that catalog and still GATE. The OpenAPI file URL and credentials are still GATE. Internal pack use is owner-approved. Commercial App Store redistribution is not authorized.
