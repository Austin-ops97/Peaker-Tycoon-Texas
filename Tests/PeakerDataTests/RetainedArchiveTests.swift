...
@Test func retainedSampleInventoryListsDeliveryDatesWithoutClaimingCoverage() throws {
    ...
    #expect(inventory.retainFolders == ["batch2", "batch3", "batch4", "batch5", "batch6", "batch7", "batch8"])
    ...
    #expect(np4.zipCount == 66)
    #expect(np6.zipCount == 72)
...
@Test func retainedSamplePlayerSummaryStaysIncomplete() throws {
    ...
    #expect(summary.fileSentence == "66 day-ahead price files and 72 real-time price files are saved with this build.")
