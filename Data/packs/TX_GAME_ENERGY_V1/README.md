...
`coverage-manifest.json` is still a **GATE** document. It names the campaign era and the fictional proxy sites. `source_batch_count` is 88 because eighty-eight price-instance zips verified (6 + 6 + 13 + 24 + 14 + 25 in `Data/archives/ercot/2026-09-24/batch6/`). That count is not five-year coverage. September 2026 RT samples are not coverage days. Live From/To sampled in batch 6 is empty for 2022-11-15. Batch 6 archive files include delivery dates 2021-04-15, 2022-07-15, 2023-01-15, and 2023-04-15. Earlier empty artifact days that this drop did not re-query include 2021-02-15, 2021-08-15, 2022-02-15, and 2023-08-15. Proxy `source_point_id` values stay null. `operating_days` stays empty.

A read path (`RetainedSettlementArchive`) can open the verified batch2–batch6 price zips and parse them. `retained-sample-inventory.json` lists the CSV delivery dates in those zips. That is retained samples only, not complete coverage, and it does not fill proxy `covered_local_dates`. The inventory’s live-empty day is 2022-11-15. Archive samples now include 2021-04-15, 2022-07-15, 2023-01-15, and 2023-04-15.
