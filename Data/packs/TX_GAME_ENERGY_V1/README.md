...
A read path (`RetainedSettlementArchive`) can open the verified batch2–batch5 price zips and parse them. `retained-sample-inventory.json` lists the CSV delivery dates in those zips. That is retained samples only, not complete coverage, and it does not fill proxy `covered_local_dates`. Live From/To for 2021-04-15, 2022-07-15, 2023-01-15, and 2023-04-15 is still empty.
