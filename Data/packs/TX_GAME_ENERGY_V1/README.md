...
A read path (`RetainedSettlementArchive`) can open the verified batch2–batch4 price zips and parse them. Batch 5 is retained and is not on that read path. That is retained samples only, not complete coverage. Live From/To for 2021-04-15, 2022-07-15, 2023-01-15, and 2023-04-15 is still empty.
